...
export default function NavHeader() {
  ...
  return (
    <header className="fixed left-0 top-0 z-10 flex h-screen w-52 flex-col bg-base-300 p-4">
        ...
        <Link className={` ${activeSection === "home" ? "active" : ""}`} href="#home" aria-label="Home">
          {activeSection === "home" || activeSection === "/" ? (
            <Image
              ...
              height={135}
              alt="logo active"
              className="mx-auto p-2 duration-500 ease-in-out hover:scale-110 hover:animate-pulse"
            />
          ) : (
            <Image
              src={logo.src}
        ...
        <div className="flex h-full flex-col items-center justify-center">
          <ul className="nav-list flex h-full w-full select-none flex-col items-center justify-center space-y-20 text-lg text-base-200">
            <li className="w-full">
              ...
              >
                <h3 className="text-center text-lg font-bold">ABOUT</h3>
                <div className="flex items-center justify-center">
                  <span
                    className={`max-w-7 flex-grow border-t border-base-200 duration-500 ease-in-out  group-hover:border-primary ${activeSection === "about" ? "border-primary" : "border-base-200"}`}
                  />
                ...
                <h6 className="text-center text-xs italic">READ BIO</h6>
              </Link>
            </li>
            <li className="w-full">
              <Link
              ...
              >
                <h3 className="text-center text-lg font-bold">RESUME</h3>
                <div className="flex items-center justify-center">
                  <span
                    className={`max-w-7 flex-grow border-t border-base-200 duration-500 ease-in-out  group-hover:border-primary ${activeSection === "resume" ? "border-primary" : "border-base-200"}`}
                  />
                ...
                <h6 className="text-center text-xs italic">VIEW EXPERIENCE</h6>
              </Link>
            </li>
            <li className="w-full">
              <Link
              ...
              >
                <h3 className="text-center text-lg font-bold">WORK</h3>
                <div className="flex items-center justify-center">
                  <span
                    className={`max-w-7 flex-grow border-t border-base-200 duration-500 ease-in-out  group-hover:border-primary ${activeSection === "work" ? "border-primary" : "border-base-200"}`}
                  />
                ...
                <h6 className="text-center text-xs italic">BROWSE PROJECTS</h6>
              </Link>
            </li>
            <li className="w-full">
              <Link
              ...
              >
                <h3 className="text-center text-lg font-bold">CONTACT</h3>
                <div className="flex items-center justify-center">
                  <span
                    className={`max-w-7 flex-grow border-t border-base-200 duration-500 ease-in-out  group-hover:border-primary ${activeSection === "contact" ? "border-primary" : "border-base-200"}`}
                  />
                ...
                <h6 className="text-center text-xs italic">GET IN TOUCH</h6>
              </Link>
            </li>
          </ul>
        </div>
